...
A simple and beutiful theme perfect for bloggin or personal sites.

== Description ==

A simple and beautiful theme for bloggs and personal sites. 
Focused on lightweight and clean typography to provide the 
...
= 1.0.2 - Dec 7 2021 =
* Simplified namespace to white-nina
* fixed prefixes
...
White Nina Wordpress Theme
Copyright (C) 2021  Mario Badilla
...
with this program; if not, write to mbadilla@uned.ac.cr.
